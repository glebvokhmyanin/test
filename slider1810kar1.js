...
var list = caro.querySelector('ul');
var ListElements = caro.querySelectorAll('li');
var position = 0;
...
caro.querySelector ('.prev').onclick = function(){
...
caro.querySelector('.next').onclick = function(){
